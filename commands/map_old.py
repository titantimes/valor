...
async def _register_map_old(valor: Valor):
    desc = "100 percent an Athena knockoff"
    parser = argparse.ArgumentParser(description='Old map command')
    ...
    @valor.command()
    async def map_old(ctx: Context, *options):
